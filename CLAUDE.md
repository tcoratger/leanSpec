...
uv run fill --fork=devnet4 --clean -n auto                # Generate test vectors
uv run fill --fork=devnet4 --clean -n auto --scheme=prod  # Generate test vectors with production scheme
...
- Run `uv run fill --fork=Devnet4 --clean -n auto` to generate consensus fixtures
