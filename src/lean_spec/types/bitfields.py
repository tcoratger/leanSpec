...
class Bitlist(list[Boolean], SSZType, metaclass=BitlistType):
    ...
    def __add__(self, other: list[Boolean]) -> Bitlist:  # type: ignore[override] # <-- FIX 2
    ...
    def __iadd__(self, other: Iterable[bool | int]) -> Self:  # type: ignore[override] # <-- FIX 2
